...
public class Exercicio07 {
	public static void main(String args[]) {
		...
		soma = a * b;
		System.out.println("A Multiplicação entre: " + a + " e " + b + " é :" + soma );
		
		soma = a * c;
		System.out.println("A Multiplicação entre: " + a + " e " + c + " é :" + soma );
		
		soma = a * d;
		System.out.println("A Multiplicação entre: " + a + " e " + d + " é :" + soma );
		
		soma = b * c;
		System.out.println("A Multiplicação entre: " + b + " e " + c + " é :" + soma );
		
		soma = b * d;
		System.out.println("A Multiplicação entre: " + b + " e " + d + " é :" + soma );
		
		soma = c * d;
		System.out.println("A Multiplicação entre: " + c + " e " + d + " é :" + soma );
